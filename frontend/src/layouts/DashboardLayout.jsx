...
const DashboardLayout = ({ children, user, onLogout }) => {
    ...
    return (
        <div className='min-h-screen w-full flex bg-bg text-text-primary'>
            {/* Desktop Sidebar */}
            <aside className='hidden md:flex w-64 h-screen bg-bg-secondary border-r border-bg-border flex flex-col shrink-0 sticky top-0'>
                {/* Logo/Brand */}
            ...
            <div aria-hidden={!sidebarOpen} className="md:hidden">
                ...
                <div className="fixed top-3 left-3 z-40">
                    <button
                        ...
                        className="p-2 rounded-md bg-transparent text-text-primary shadow-md"
                    >
                        {sidebarOpen ? (
                ...
                {sidebarOpen && (
                    <div className="fixed inset-0 z-30">
                        ...
                        <aside className="absolute left-0 top-0 bottom-0 w-64 bg-bg-secondary border-r border-bg-border p-0 z-40 overflow-y-auto">
                            ...
                            <div className='px-4 py-4'>
                                <button
                                    onClick={() => { navigate("/review/new"); setSidebarOpen(false); }}
                                    className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-primary hover:bg-primary-hover text-white rounded-lg font-medium transition-colors"
                                >
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
