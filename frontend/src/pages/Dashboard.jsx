            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="bg-bg-card border border-bg-border rounded-lg p-6 hover:border-primary/50 transition-colors">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className={`text-xs font-medium ${stats.totalReviewsChange > 0 ? 'text-green-400' : 'text-red-400'}`}>
                    {stats.totalReviewsChange > 0 ? '+' : ''}{stats.totalReviewsChange}%
                  </span>
                </div>
                <div className="text-3xl font-bold text-text-primary mb-1">{stats.totalReviews}</div>
              ...
              <div className="bg-bg-card border border-bg-border rounded-lg p-6 hover:border-primary/50 transition-colors">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className={`text-xs font-medium ${stats.issuesDetectedChange > 0 ? 'text-red-400' : 'text-green-400'}`}>
                    {stats.issuesDetectedChange > 0 ? '+' : ''}{stats.issuesDetectedChange}%
                  </span>
                </div>
                <div className="text-3xl font-bold text-text-primary mb-1">{stats.issuesDetected}</div>
                <div className="text-sm text-text-secondary">Issues Detected</div>
              </div>
              ...
              <div className="bg-bg-card border border-bg-border rounded-lg p-6 hover:border-primary/50 transition-colors">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className={`text-xs font-medium ${stats.issuesResolvedChange > 0 ? 'text-green-400' : 'text-red-400'}`}>
                    {stats.issuesResolvedChange > 0 ? '+' : ''}{stats.issuesResolvedChange}%
                  </span>
                </div>
                <div className="text-3xl font-bold text-text-primary mb-1">{stats.issuesResolved}</div>
              ...
              <div className="bg-bg-card border border-bg-border rounded-lg p-6 hover:border-primary/50 transition-colors">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className={`text-xs font-medium ${stats.avgReviewTimeChange < 0 ? 'text-green-400' : 'text-red-400'}`}>
                    {stats.avgReviewTimeChange > 0 ? '+' : ''}{stats.avgReviewTimeChange}%
                  </span>
                </div>
                <div className="text-3xl font-bold text-text-primary mb-1">{stats.avgReviewTime}m</div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-bg-border">
                    <th className="px-6 py-3 text-left text-xs font-semibold text-text-secondary uppercase tracking-wider">Repository</th>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-text-secondary uppercase tracking-wider">Branch</th>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-text-secondary uppercase tracking-wider">Status</th>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-text-secondary uppercase tracking-wider">Issues</th>
                    ...
                    >
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium text-text-primary">{review.repository}</span>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
